...
describe 'API Cobranças' do
  it 'POST api/v1/invoices' do
    ...
    params = { invoice: { total_price: 50, package_id: 1, registration_number: '12345678', insurance_company_id: company.id,
    ...
    expect(Invoice.last.registration_number).to eq('12345678')
