...
RSpec.describe Invoice, type: :model do
  ...
  describe '#valid?' do
    ...
    it 'sendo order_id obrigatórios' do
      ...
      invoice = build(:invoice, payment_method:, insurance_company:, order_id: nil)
    ...
    it 'sendo package_id obrigatórios' do
      ...
      invoice = build(:invoice, payment_method:, insurance_company:, package_id: nil)
    ...
    it 'sendo total_price obrigatórios' do
      ...
      invoice = build(:invoice, payment_method:, insurance_company:, total_price: nil)
    ...
    it 'sendo parcels obrigatórios' do
      ...
      invoice = build(:invoice, payment_method:, insurance_company:, parcels: nil)
