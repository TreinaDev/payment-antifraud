  ...
  describe '#valid?' do
    context 'atributo obrigatório' do
      it 'nome é obrigatório' do
        payment_method = build(:payment_method, name: '')
      ...
      it 'Taxa por Cobrança é obrigatório' do
        payment_method = build(:payment_method, tax_percentage: '')
        payment_method.valid?
      ...
      it 'Taxa Máxima é obrigatório' do
        payment_method = build(:payment_method, tax_maximum: '')
        payment_method.valid?
      ...
      it 'Tipo de pagamento é obrigatório' do
        payment_method = build(:payment_method, payment_type: '')
        payment_method.valid?
      ...
      it 'Ícone é obrigatório' do
        payment_method = build(:payment_method, image: nil)
        payment_method.valid?
    ...
    context 'atributo postivo' do
      it 'Taxa por Cobrança é positivo' do
        payment_method = build(:payment_method, tax_percentage: -10)
        payment_method.valid?
      ...
      it 'Taxa Máxima é positivo' do
        payment_method = build(:payment_method, tax_maximum: -10)
        payment_method.valid?
