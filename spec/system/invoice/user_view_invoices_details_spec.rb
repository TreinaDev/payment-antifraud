...
describe 'Usuário vê detalhes de uma cobranças' do
  it 'com sucesso' do
    ...
    expect(page).to have_content "Pacote de Seguros: #{invoice.package_id}"
