...
describe 'Usuário edita opção de pagamento para sua seguradora' do
  it 'a partir de um formulário' do
    ...
    expect(page).to have_field 'Tipo de Pagamento', with: payment_method.id.to_s
  ...
  it 'com sucesso' do
    ...
    FactoryBot.create(:payment_method, name: 'Débito Nubank', payment_type: 'Pix')
    ...
    select 'Débito Nubank - Pix', from: 'Tipo de Pagamento'
    ...
    expect(page).to have_content 'Opção de Pagamento: Débito Nubank'
